...
class PostTest(TestCase):
    def setUp(self):
        ...
        posts = [
            Post(title='new_post1', author=user),
            Post(title='new_post2', author=user),
            Post(title='new_post3', author=user),
        ]
    ...
    def test_list(self):
        ...
        assert response.data['results'][0]['title'] == 'new_post1'
    ...
    def test_retrieve(self):
        ...
        assert response.data['title'] == 'new_post1'
